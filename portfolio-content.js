...
(() => {
  ...
  d.projects = [
    {name:'UFFF', mark:'U!', language:'HTML', tone:'lavender', page:'https://aozkul.github.io/UFFF/', pageEn:'https://aozkul.github.io/UFFF/en/', icon:'https://raw.githubusercontent.com/aozkul/UFFF/main/public/assets/app-icon.png', description:{tr:'UFFF için tanıtım, destek ve gizlilik sayfaları.',en:'The UFFF website, support and privacy pages.'}},
    {name:'NuThings_v1', mark:'N°', language:'TypeScript', tone:'sage', icon:'https://raw.githubusercontent.com/aozkul/NuThings_v1/main/public/logo.png', logo:true, description:{tr:'Next.js ve Supabase ile ürün kataloğu, yönetim ve e-ticaret projesi.',en:'A product catalogue, administration and e-commerce project built with Next.js and Supabase.'}},
    {name:'VocabLens', mark:'Aa', language:'HTML', tone:'lavender', page:'https://aozkul.github.io/VocabLens/', description:{tr:'VocabLens ana sayfası, gizlilik ve kullanım koşulları.',en:'The VocabLens landing page, privacy policy and terms of use.'}},
    {name:'MathRush', mark:'x²', language:null, tone:'peach', description:{tr:'MathRush uygulamasının herkese açık gizlilik ve reklam doğrulama dosyaları.',en:'Public privacy and advertising-verification files for MathRush.'}},
    {name:'PaceQ', mark:'PQ', language:'HTML', tone:'blue', page:'https://aozkul.github.io/PaceQ/', description:{tr:'PaceQ uygulamasının ana sayfası ve gizlilik bilgileri.',en:'The PaceQ app website and privacy information.'}},
    {name:'NotNow', mark:'N.', language:'HTML', tone:'yellow', page:'https://aozkul.github.io/NotNow/', pageEn:'https://aozkul.github.io/NotNow/index-en.html', description:{tr:'Üç dilde uygulama bilgileri, destek ve gizlilik sayfaları.',en:'App information, support and privacy pages in three languages.'}},
    {name:'PayGuard', mark:'PG', language:null, tone:'rose', page:'https://aozkul.github.io/PayGuard/', description:{tr:'PayGuard uygulamasının destek, gizlilik ve kullanım bilgileri.',en:'Support, privacy and usage information for the PayGuard app.'}},
    {name:'aozkul.github.io', mark:'aö.', language:'HTML', tone:'sage', page:'https://aozkul.github.io/', icon:'favicon.svg', description:{tr:'Projelerimi ve profesyonel deneyimimi bir araya getiren kişisel portföyüm.',en:'My personal portfolio, bringing together my projects and professional experience.'}}
  ...
  const tr = {
    ...
    'projects.description':'Herkese açık GitHub depolarımın tamamı. Kartlar, mevcutsa projenin kendi web sayfasını açar; ayrı GitHub bağlantısı kaynak dosyalarına götürür.',
    'projects.note':'Bu liste herkese açık depolarımı içerir. Özel depolarım ve şirket içi kaynak kodları yayımlanmaz. Web sayfası olmayan projelerde depo bağlantısı kullanılır.',
  ...
  const en = {
    ...
    'projects.description':'All my public GitHub repositories. Cards open the project’s own website where available; the separate GitHub link leads to its source files.',
    'projects.note':'This list includes my public repositories. Private repositories and internal company source code are not published. Projects without a website link to their repository.',
